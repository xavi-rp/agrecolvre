...
#------------------------------------------------------------------------
#---------  Here starts 2nd part (analysis) --> New wrapper  ------------
#------------------------------------------------------------------------


### step 3: PCA ####

## 'LucasS2018_sameLU'  is the dataset to be analysed. It can come from the 1st part (above)
...
#### Step 3a: Selecting Area of Study ####
...
## 'LucasS2018_sameLU'  is the dataset to be analysed. It can come from the 1st part (above)
## or ingested from own data, as long as the format are the same than for LUCAS: 
## one column for region (NUTS0, 1, 2, 3)
## several columns for soil attributes
## one colum called 'LC' with the Land cover / Land use, following LUCAS codification (BXX, croplands;
## CXX, woodland; DXX, shrubland; EXX, grassland)


#### Step 4a: Selecting Area of Study ####
## Selecting region (Galicia --> NUTS_2 == ES11)
## And selecting forests, shrublands and grasslands for the analyses
